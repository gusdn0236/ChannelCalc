    ...
    case 4: // 갈바캡잔넬
      if (selectedLang === 'kor') {
        priceTable = [
          ...
          103000, 112000, 120000, 135000, 148000, 175000, 202000, 240000,
          280000, 330000, 360000, 450000, 510000, 570000, 640000,
        ];
      } else {
        priceTable = [
          42000, 42000, 51000, 55000, 60000, 66000, 72000, 78000, 85000, 93000,
          103000, 112000, 120000, 135000, 148000, 175000, 202000, 240000,
          280000, 330000, 360000, 450000, 510000, 570000, 640000,
        ];
      }
