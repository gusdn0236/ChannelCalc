function calculate() {
  ...
  switch (type) {
    case 1:
      priceTable = [25000, 31000, 35000, 39000, 42000, 45000, 48000, 52000, 56000, 60000, 65000, 70000, 76000, 83000, 90000, 99000, 115000, 139000, 165000, 195000, 225000, 250000, 290000, 330000, 370000];
      break;
    case 2:
      priceTable = [35000, 43000, 46000, 50000, 54000, 59000, 63000, 69000, 75000, 82000, 88000, 95000, 105000, 115000, 125000, 134000, 147000, 175000, 210000, 240000, 280000, 330000, 370000, 420000, 470000];
      break;
    case 3:
      priceTable = [53000, 53000, 57000, 62000, 68000, 75000, 82000, 90000, 100000, 110000, 123000, 135000, 152000, 170000, 187000, 222000, 246000, 295000, 350000, 410000, 480000, 550000, 620000, 700000, 790000];
      break;
    case 4:
      priceTable = [46000, 46000, 51000, 55000, 60000, 66000, 72000, 78000, 85000, 93000, 103000, 112000, 120000, 135000, 148000, 175000, 202000, 240000, 280000, 330000, 360000, 450000, 510000, 570000, 640000];
      break;
    case 5:
      priceTable = [40000, 45000, 53000, 60000, 65000, 70000, 75000, 82000, 90000, 100000, 110000, 120000, 130000, 145000, 160000, 177000, 196000, 215000];
      break;
    case 6:
      priceTable = [28000, 28000, 29000, 31000, 33000, 36000, 38000, 42000, 46000, 49000, 52000, 57000, 60000, 66000, 75000, 85000, 97000];
      break;
    case 7:
      priceTable = [57000, 57000, 69000, 80000, 90000, 95000, 100000, 107000, 118000, 130000, 148000, 160000, 171000, 193000, 211000, 252000, 298000, 360000, 410000, 500000, 580000, 670000, 760000, 860000, 960000];
      break;
    case 8:
      priceTable = [67000, 74000, 85000, 104000, 117000, 124000, 131000, 139000, 154000, 169000, 193000, 208000, 223000, 251000, 275000, 328000, 350000, 420000, 504000, 600000, 680000, 780000, 890000, 1010000, 1130000];
      break;
    case 9:
      priceTable = [43000, 43000, 48000, 60000, 70000, 78000, 83000, 90000, 95000, 105000, 113000, 128000, 147000, 165000, 185000, 200000, 227000, 259000, 325000, 386000, 440000, 510000, 581000, 650000, 730000];
      break;
    case 10:
      priceTable = [45000, 45000, 55000, 65000, 78000, 85000, 95000, 110000, 126000, 138000, 151000, 162000, 189000, 216000, 234000, 252000, 306000, 369000, 441000, 522000];
      break;
    default:
      alert("종류를 선택해주세요.");
      return;
