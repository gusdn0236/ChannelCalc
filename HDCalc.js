function calculate() {
  ...
  switch (type) {
    ...
    case 3:
      priceTable = [
        53000, 53000, 62000, 68000, 75000, 82000, 90000, 100000, 110000, 123000,
        135000, 152000, 170000, 187000, 222000, 246000, 270000, 295000, 350000,
        410000, 450000, 550000, 620000, 700000, 790000,
      ];
      break;
    case 4:
      priceTable = [
        51000, 51000, 51000, 55000, 60000, 66000, 72000, 78000, 85000, 93000,
        103000, 112000, 120000, 135000, 148000, 175000, 202000, 240000, 280000,
    ...
    case 7:
      priceTable = [
        ...
        130000, 148000, 16000, 171000, 193000, 211000, 252000, 298000, 360000,
    ...
    case 9:
      priceTable = [
        ...
        128000, 147000, 165000, 185000, 200000, 227000, 259000, 325000, 386000,
        440000, 510000, 581000, 650000, 730000,
      ];
      break;
    case 10:
      priceTable = [
        45000, 45000, 55000, 55000, 65000, 78000, 85000, 95000, 110000, 126000,
        138000, 151000, 162000, 189000, 216000, 234000, 252000, 306000, 369000,
        441000, 522000,
      ];
      break;
    default:
